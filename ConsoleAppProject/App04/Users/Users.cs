    ...
    public class User
    {
        ...
        public void RequestFriendship(User user)
        {
            ...
            foreach (User friend in friendList)
            {
                ...
                {
                    ConsoleHelper.PrintString(IndentLevel.Level2, $"You are friend with {user.Username}\n");
                    break;
                }
            }
        ...
        {
            if (user == this) ConsoleHelper.PrintString(IndentLevel.Level3, "Unavaiable\n");
        ...
        public void RemoveFriend(User user)
        {
            ...
            else ConsoleHelper.PrintString(IndentLevel.Level2, $"{user.Username} is no longer your friend!\n");
