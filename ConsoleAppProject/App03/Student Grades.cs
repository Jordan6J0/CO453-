...
{
    /// <summary>
    /// This class manages the student data for new, update/ adward, display,set and exit.
    /// </summary>
    public class StudentMarks
    {
        ...
        public void Run()
        {
            ...
            while (!finished)
            {
                ...
                switch (ConsoleHelper.SelectChoice("Please select an option", Choices))
                {
                    case 1:
                        AddNew();
                        break;
        ...
        /// <summary>
        /// Find students with the lowest and highest mark and calculate the mean.
        /// </summary>
        ...
        /// <summary>
        /// students with the best and worst grades.
        /// </summary>
